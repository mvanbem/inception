...
/// LightmappedGeneric, base alpha packed as aux alpha, env mapped.
pub static LIGHTMAPPED_BAAA_ENV_SHADER: Shader = Shader {
    tev_stages: tev_builder()
        ...
        // Add the env map scaled by the env map tint. Sample the aux map for alpha.
        .add_stage(
            TevStage::new(
